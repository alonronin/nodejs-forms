...
BaseField.prototype.clean_value = function(req)
{
...
BooleanField.prototype.clean_value = function(req)
{
    if(this.value && this.value != '')
        this.value = true;
    else
        this.value = false;
    BooleanField.super_.prototype.clean_value.call(this,req);
    return this;
}
...
EnumField.prototype.clean_field = function(req)
{
    var found = false;
    ...
    EnumField.super_.prototype.clean_value.call(this,req);
    return this;
};
...
NumberField.prototype.clean_value = function(req)
{
    ...
    NumberField.super_.prototype.clean_value.call(this,req);
    return this;
};
...
ListField.prototype.clean_value = function(req)
{
    ...
    for(var field_name in req.body)
    {
        ...
        if(field_name.indexOf(prefix, 0) > -1 )
        {
            ...
            var name = field_name.split(prefix)[1].split(/\d+_/)[1];
            field.name = name;
            field.set(req.body[field],req);
            field.clean_value(req);
            if(field.errors && field.errors.length)
                this.errors = Array.concat(this.errors,field.errors);
            else
